    ...
    <div className="min-h-screen bg-slate-100 font-sans flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm w-full max-w-sm p-8">
          ...
          <h1 className="text-xl font-bold text-[#1e3a5f] text-center mb-1">Admin Login</h1>
          <p className="text-sm text-slate-400 text-center mb-7">Sign in to the admin portal</p>
